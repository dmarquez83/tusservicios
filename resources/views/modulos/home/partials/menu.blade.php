<nav class="navbar bg-orange-active flat navbar-home no-margin hidden-xs">
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form navbar-right" role="search">
                <div class="input-group input-group-sm margin-05">
                    <input type="text" class="form-control" placeholder="Buscar servicio" style="width: 200px ">
