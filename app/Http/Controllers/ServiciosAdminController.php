...
class ServiciosAdminController extends AppBaseController
{
	...
	public function index()
	{
		...
		$servicios1 = DB::table('servicios')
			...
			->select('servicios.nombre','servicios.foto', 'servicios.id','servicios.descripcion','tiposervicios.nombre as nombre_tipo_servicio','estatus.nombre as nombre_estatus','ponderaciones.nombre as nombre_ponderacion', 'categorias.nombre as nombre_categoria')
			->get();
